## Worked on a marketing piece by exploring data provided by The Nahville City Cemetery Association. 

## I had fun creating a couple charts with some of the data that I found interesting. 

## I used the questions below to explore the data and to gain some insights on the data. 
