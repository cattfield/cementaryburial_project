...
**As a class we used the questions below to explore the data and to gain some insights on the data. Individually we had fun creating a couple of charts on our own using data we found interesting.**

**The visualization I created is below.** 
